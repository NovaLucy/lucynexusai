...
export default function TopBar({
  ...
  return (
    <div className="dark-matter rounded-full mx-3 sm:mx-6 mt-2 flex items-center justify-between px-4 sm:px-6 py-2.5 text-[10px] uppercase tracking-[0.3em] font-light text-drop">
      {/* Left: status */}
